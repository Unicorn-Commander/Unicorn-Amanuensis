module @mel_npu_with_loop attributes {llvm.target_triple = "aie2"} {
  memref.global "public" @of_in_cons_buff_1 : memref<800xi8>
  memref.global "public" @of_in_cons_buff_0 : memref<800xi8>
  memref.global "public" @of_out_buff_1 : memref<80xi8>
  memref.global "public" @of_out_buff_0 : memref<80xi8>
