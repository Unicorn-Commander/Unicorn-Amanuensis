#!/usr/bin/env python3
"""Simple test for freshly compiled mel_fixed kernel"""
import sys
...
print("=" * 60)
print("Testing Simple MEL Kernel on AMD Phoenix NPU")
print("=" * 60)
print()
...
try:
    ...
    if state == xrt.ert_cmd_state.ERT_CMD_STATE_COMPLETED:
        print("   🎉 SUCCESS! Kernel executed successfully!")
        ...
        if non_zero >= 70:
            print("\n   ✅ EXCELLENT! All bins processing audio")
        elif non_zero >= 40:
            print("\n   ✅ GOOD! Most bins processing audio")
        else:
