//===- mel_with_loop.mlir --------------------------------------*- MLIR -*-===//
//
// MEL INT8 kernel with INFINITE LOOP (event-driven execution)
// Based on working matrix_transpose and add_one examples from MLIR-AIE
//
// KEY DIFFERENCE: Core has infinite loop with ObjectFIFO acquire/release
//===----------------------------------------------------------------------===//
    ...
    aie.device(npu1) {
        ...
        %core02 = aie.core(%tile02) {
            ...
            scf.for %iter = %c0 to %c_max step %c1 {
                ...
                // Call C kernel function (pure computation, no loop needed)
