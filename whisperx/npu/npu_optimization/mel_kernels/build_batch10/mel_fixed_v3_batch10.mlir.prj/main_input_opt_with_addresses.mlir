module @mel_npu_batch10 attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @of_in_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<8000 x i8>
  llvm.mlir.global external @of_in_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<8000 x i8>
  llvm.mlir.global external @of_out_buff_1() {addr_space = 0 : i32} : !llvm.array<800 x i8>
  llvm.mlir.global external @of_out_buff_0() {addr_space = 0 : i32} : !llvm.array<800 x i8>
  ...
  ^bb4:  // pred: ^bb3
    %19 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<8000 x i8>
  ...
  ^bb7:  // pred: ^bb6
    %24 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<8000 x i8>
    %25 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<800 x i8>
  ...
  ^bb11:  // pred: ^bb10
    %30 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<8000 x i8>
    %31 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<800 x i8>
