module @mel_npu_batch10 {
  aie.device(npu1) {
    ...
    %of_out_buff_0 = aie.buffer(%tile_0_2) {address = 17024 : i32, sym_name = "of_out_buff_0"} : memref<800xi8> 
    %of_out_buff_1 = aie.buffer(%tile_0_2) {address = 17824 : i32, sym_name = "of_out_buff_1"} : memref<800xi8> 
    ...
    %of_in_cons_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "of_in_cons_buff_0"} : memref<8000xi8> 
    %of_in_cons_buff_1 = aie.buffer(%tile_0_2) {address = 9024 : i32, sym_name = "of_in_cons_buff_1"} : memref<8000xi8> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/ucadmin/UC-1/Unicorn-Amanuensis/whisperx/npu/npu_optimization/mel_kernels/build_batch10/mel_fixed_v3_batch10.mlir.prj/main_core_0_2.elf", link_with = "mel_fixed_combined.o"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[2000, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[200, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
