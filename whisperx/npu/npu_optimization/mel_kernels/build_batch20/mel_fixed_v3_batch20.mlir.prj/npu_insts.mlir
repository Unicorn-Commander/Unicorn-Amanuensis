module @mel_npu_batch20 {
  aie.device(npu1) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/ucadmin/UC-1/Unicorn-Amanuensis/whisperx/npu/npu_optimization/mel_kernels/build_batch20/mel_fixed_v3_batch20.mlir.prj/main_core_0_2.elf", link_with = "mel_fixed_combined.o"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[4000, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[400, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
