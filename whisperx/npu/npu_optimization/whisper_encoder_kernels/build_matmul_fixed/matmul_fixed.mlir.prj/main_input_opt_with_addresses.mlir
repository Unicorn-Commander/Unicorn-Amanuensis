module @matmul_npu attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.func @matmul_int8_16x16_packed(!llvm.ptr, !llvm.ptr) attributes {sym_visibility = "private"}
  llvm.func @core_0_2() {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %16 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<512 x i8>
    llvm.call @matmul_int8_16x16_packed(%16, %15) : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %18 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<512 x i8>
    llvm.call @matmul_int8_16x16_packed(%18, %17) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
  ...
  ^bb3:  // pred: ^bb1
    ...
    %21 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<512 x i8>
    llvm.call @matmul_int8_16x16_packed(%21, %20) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
    llvm.return
  }
