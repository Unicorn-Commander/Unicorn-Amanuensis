#!/usr/bin/env python3
"""
Test Matrix Multiplication BF16 Kernel on AMD Phoenix NPU
Based on test_softmax.py pattern
...
def main():
    print("=" * 70)
    print("Matrix Multiplication BF16 Kernel Test - AMD Phoenix NPU")
    print("=" * 70)
    print()
    ...
    # Paths
    xclbin_path = "build_matmul/matmul_bf16.xclbin"
    insts_path = "build_matmul/insts.bin"
    ...
    try:
        ...
        print("=" * 70)
        print("TEST COMPLETE - MatMul kernel working on NPU!")
        print("=" * 70)
