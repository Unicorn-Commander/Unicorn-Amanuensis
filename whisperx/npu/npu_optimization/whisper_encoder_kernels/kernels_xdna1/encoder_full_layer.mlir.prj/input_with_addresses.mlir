module @whisper_encoder_full_layer {
  aie.device(npu1) {
    ...
    aie.flow(%tile_0_4, DMA : 0, %tile_1_3, DMA : 0)
    aie.flow(%tile_1_4, DMA : 0, %tile_2_2, DMA : 0)
    aie.flow(%tile_0_2, DMA : 1, %tile_2_2, DMA : 1)
    aie.flow(%tile_2_4, DMA : 0, %tile_3_2, DMA : 0)
    aie.flow(%tile_3_3, DMA : 0, %shim_noc_tile_0_0, DMA : 0)
