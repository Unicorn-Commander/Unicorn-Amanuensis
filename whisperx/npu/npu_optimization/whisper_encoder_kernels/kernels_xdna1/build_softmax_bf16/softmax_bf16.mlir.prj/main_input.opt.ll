; ModuleID = '/home/ucadmin/UC-1/Unicorn-Amanuensis/whisperx/npu/npu_optimization/whisper_encoder_kernels/kernels_xdna1/build_softmax_bf16/softmax_bf16.mlir.prj/main_input.llpeanohack.ll'
...
1:                                                ; preds = %5, %0
  ...
  tail call void @softmax_bf16(ptr nonnull @of_input_cons_buff_0, ptr nonnull @of_output_buff_0)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.acquire(i32 50, i32 -1)
  tail call void @softmax_bf16(ptr nonnull @of_input_cons_buff_1, ptr nonnull @of_output_buff_1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.acquire(i32 50, i32 -1)
