module @softmax_parallel_2tile_npu {
  aie.device(npu1) {
    ...
    aiex.runtime_sequence(%arg0: memref<2048xi8>, %arg1: memref<2048xi8>, %arg2: memref<2048xi8>, %arg3: memref<2048xi8>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg2[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 2 : i64, metadata = @of_output0_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg3[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 3 : i64, metadata = @of_output1_shim_alloc} : memref<2048xi8>
