...
//
// Adapted for Phoenix NPU (XDNA1) - Whisper Encoder Optimization
// Source: /home/ucadmin/mlir-aie-source/aie_kernels/aie2/bf16_softmax.cc
// Target: AMD Ryzen AI Phoenix (4 columns, AIE2 architecture)
//
// BF16 Softmax: Higher precision alternative to INT8 softmax
// Uses scalar implementation for better numerical stability
//===----------------------------------------------------------------------===//
...
void softmax_bf16(bfloat16 *restrict input, bfloat16 *restrict output) {
  softmax_simple_bf16(input, output, 1024);
}
