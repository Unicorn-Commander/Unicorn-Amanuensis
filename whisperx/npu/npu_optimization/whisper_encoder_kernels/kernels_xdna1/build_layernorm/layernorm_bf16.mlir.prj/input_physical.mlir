module @layernorm_bf16_npu {
  aie.device(npu1) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @layernorm_simple_bf16(%of_input_cons_buff_0, %of_output_buff_0) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
      aie.use_lock(%of_input_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @layernorm_simple_bf16(%of_input_cons_buff_1, %of_output_buff_1) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
