...
4:                                                ; preds = %1
  ...
  call void @layernorm_simple_bf16(ptr @of_input_cons_buff_0, ptr @of_output_buff_0)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.aie2.acquire(i32 50, i32 -1)
  call void @layernorm_simple_bf16(ptr @of_input_cons_buff_1, ptr @of_output_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  %5 = add i64 %2, 2
  br label %1
