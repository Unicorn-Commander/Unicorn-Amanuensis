module @gelu_bf16_npu attributes {llvm.target_triple = "aie2"} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    llvm.call @gelu_bf16(%16, %15) : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    llvm.call @gelu_bf16(%18, %17) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
  ...
  ^bb3:  // pred: ^bb1
    ...
    llvm.call @gelu_bf16(%21, %20) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
    llvm.return
  }
