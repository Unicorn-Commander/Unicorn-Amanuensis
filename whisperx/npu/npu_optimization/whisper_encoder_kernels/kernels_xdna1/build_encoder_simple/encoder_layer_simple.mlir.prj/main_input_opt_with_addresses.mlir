module @encoder_layer_simple_npu attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @of_input_to_ln_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_input_to_ln_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_ln_to_softmax_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_ln_to_softmax_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_softmax_to_gelu_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_softmax_to_gelu_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_gelu_to_output_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @of_gelu_to_output_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  ...
  llvm.func @layernorm_simple_bf16(!llvm.ptr, !llvm.ptr) attributes {sym_visibility = "private"}
  ...
  llvm.func @core_0_4() {
    %0 = llvm.mlir.addressof @of_softmax_to_gelu_buff_1 : !llvm.ptr
    %1 = llvm.mlir.addressof @of_gelu_to_output_buff_1 : !llvm.ptr
    %2 = llvm.mlir.addressof @of_softmax_to_gelu_buff_0 : !llvm.ptr
    %3 = llvm.mlir.addressof @of_gelu_to_output_buff_0 : !llvm.ptr
  ...
  llvm.func @core_0_3() {
    %0 = llvm.mlir.addressof @of_ln_to_softmax_buff_1 : !llvm.ptr
    %1 = llvm.mlir.addressof @of_softmax_to_gelu_buff_1 : !llvm.ptr
    %2 = llvm.mlir.addressof @of_ln_to_softmax_buff_0 : !llvm.ptr
    %3 = llvm.mlir.addressof @of_softmax_to_gelu_buff_0 : !llvm.ptr
  ...
  llvm.func @core_0_2() {
    %0 = llvm.mlir.addressof @of_input_to_ln_cons_buff_1 : !llvm.ptr
    %1 = llvm.mlir.addressof @of_ln_to_softmax_buff_1 : !llvm.ptr
    %2 = llvm.mlir.addressof @of_input_to_ln_cons_buff_0 : !llvm.ptr
    %3 = llvm.mlir.addressof @of_ln_to_softmax_buff_0 : !llvm.ptr
    %4 = llvm.mlir.constant(2 : index) : i64
    %5 = llvm.mlir.constant(4294967294 : index) : i64
  ...
  ^bb2:  // pred: ^bb1
    ...
    %15 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    %16 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    llvm.call @layernorm_simple_bf16(%16, %15) : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %17 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    %18 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    llvm.call @layernorm_simple_bf16(%18, %17) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
  ...
  ^bb3:  // pred: ^bb1
    ...
    %20 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    %21 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    llvm.call @layernorm_simple_bf16(%21, %20) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%7, %10) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %10) : (i32, i32) -> ()
    llvm.return
  }
