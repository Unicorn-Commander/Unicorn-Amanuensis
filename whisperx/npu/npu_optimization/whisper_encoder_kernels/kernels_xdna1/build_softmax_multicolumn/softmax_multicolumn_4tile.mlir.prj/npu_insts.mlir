module @softmax_multicolumn_4tile_npu {
  aie.device(npu1) {
    ...
    aiex.runtime_sequence(%arg0: memref<2048xi8>, %arg1: memref<2048xi8>, %arg2: memref<2048xi8>, %arg3: memref<2048xi8>, %arg4: memref<2048xi8>, %arg5: memref<2048xi8>, %arg6: memref<2048xi8>, %arg7: memref<2048xi8>) {
      ...
      aiex.npu.address_patch {addr = 33673284 : ui32, arg_idx = 2 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 33673316 : ui32, arg_idx = 3 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 118916 : ui32, arg_idx = 4 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 118948 : ui32, arg_idx = 5 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 33673412 : ui32, arg_idx = 6 : i32, arg_plus = 0 : i32}
      ...
      aiex.npu.address_patch {addr = 33673444 : ui32, arg_idx = 7 : i32, arg_plus = 0 : i32}
