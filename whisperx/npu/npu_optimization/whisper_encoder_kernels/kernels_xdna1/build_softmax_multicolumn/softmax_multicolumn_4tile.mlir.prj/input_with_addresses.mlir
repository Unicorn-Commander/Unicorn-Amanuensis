module @softmax_multicolumn_4tile_npu {
  aie.device(npu1) {
    ...
    aie.flow(%shim_noc_tile_1_0, DMA : 1, %tile_1_3, DMA : 0)
    aie.flow(%tile_1_2, DMA : 0, %shim_noc_tile_1_0, DMA : 0)
    aie.flow(%tile_1_3, DMA : 0, %shim_noc_tile_1_0, DMA : 1)
    ...
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output0_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input0_cons_buff_0, %of_output0_buff_0) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output0_cons_lock_0, Release, 1)
      aie.use_lock(%of_input0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output0_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input0_cons_buff_1, %of_output0_buff_1) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output0_cons_lock_0, Release, 1)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb2
      ...
      cf.cond_br %1, ^bb2, ^bb3
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output1_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input1_cons_buff_0, %of_output1_buff_0) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input1_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output1_cons_lock_0, Release, 1)
      aie.use_lock(%of_input1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output1_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input1_cons_buff_1, %of_output1_buff_1) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input1_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output1_cons_lock_0, Release, 1)
      %2 = arith.addi %0, %c2 : index
      cf.br ^bb1(%2 : index)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb2
      ...
      cf.cond_br %1, ^bb2, ^bb3
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output2_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input2_cons_buff_0, %of_output2_buff_0) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input2_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output2_cons_lock_0, Release, 1)
      aie.use_lock(%of_input2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output2_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input2_cons_buff_1, %of_output2_buff_1) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input2_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output2_cons_lock_0, Release, 1)
      %2 = arith.addi %0, %c2 : index
      cf.br ^bb1(%2 : index)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb2
      ...
      cf.cond_br %1, ^bb2, ^bb3
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input3_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output3_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input3_cons_buff_0, %of_output3_buff_0) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input3_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output3_cons_lock_0, Release, 1)
      aie.use_lock(%of_input3_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output3_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @softmax_bf16(%of_input3_cons_buff_1, %of_output3_buff_1) : (memref<2048xi8>, memref<2048xi8>) -> ()
      aie.use_lock(%of_input3_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output3_cons_lock_0, Release, 1)
      %2 = arith.addi %0, %c2 : index
      cf.br ^bb1(%2 : index)
    ...
    aiex.runtime_sequence(%arg0: memref<2048xi8>, %arg1: memref<2048xi8>, %arg2: memref<2048xi8>, %arg3: memref<2048xi8>, %arg4: memref<2048xi8>, %arg5: memref<2048xi8>, %arg6: memref<2048xi8>, %arg7: memref<2048xi8>) {
      aiex.npu.dma_memcpy_nd(%arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 0 : i64, metadata = @of_input0_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 1 : i64, metadata = @of_input1_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg2[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 2 : i64, metadata = @of_input2_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg3[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 3 : i64, metadata = @of_input3_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg4[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 4 : i64, metadata = @of_output0_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg5[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 5 : i64, metadata = @of_output1_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg6[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 6 : i64, metadata = @of_output2_shim_alloc} : memref<2048xi8>
      aiex.npu.dma_memcpy_nd(%arg7[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c2048_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 7 : i64, metadata = @of_output3_shim_alloc} : memref<2048xi8>
