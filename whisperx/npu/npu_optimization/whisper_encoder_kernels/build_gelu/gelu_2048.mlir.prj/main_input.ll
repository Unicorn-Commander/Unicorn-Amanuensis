...
declare void @gelu_int8_2048(ptr, ptr, i32)
...
4:                                                ; preds = %1
  ...
  call void @gelu_int8_2048(ptr @of_input_cons_buff_0, ptr @of_output_buff_0, i32 2048)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.aie2.acquire(i32 50, i32 -1)
  call void @gelu_int8_2048(ptr @of_input_cons_buff_1, ptr @of_output_buff_1, i32 2048)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  %5 = add i64 %2, 2
  br label %1
