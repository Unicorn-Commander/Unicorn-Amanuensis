module @gelu_npu {
  aie.device(npu1) {
    ...
    %of_output_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "of_output_buff_0"} : memref<512xi8> 
    %of_output_buff_1 = aie.buffer(%tile_0_2) {address = 1536 : i32, sym_name = "of_output_buff_1"} : memref<512xi8> 
    ...
    %of_input_cons_buff_0 = aie.buffer(%tile_0_2) {address = 2048 : i32, sym_name = "of_input_cons_buff_0"} : memref<512xi8> 
    %of_input_cons_buff_1 = aie.buffer(%tile_0_2) {address = 2560 : i32, sym_name = "of_input_cons_buff_1"} : memref<512xi8> 
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @gelu_int8_512(%of_input_cons_buff_0, %of_output_buff_0, %c512_i32) : (memref<512xi8>, memref<512xi8>, i32) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
      aie.use_lock(%of_input_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @gelu_int8_512(%of_input_cons_buff_1, %of_output_buff_1, %c512_i32) : (memref<512xi8>, memref<512xi8>, i32) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<512xi8>, %arg1: memref<512xi8>) {
      aiex.npu.dma_memcpy_nd(%arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c512_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 1 : i64, metadata = @of_input_shim_alloc} : memref<512xi8>
      aiex.npu.dma_memcpy_nd(%arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64][%c1_i64, %c1_i64, %c1_i64, %c512_i64][%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 0 : i64, metadata = @of_output_shim_alloc} : memref<512xi8>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%of_input_cons_buff_0 : memref<512xi8>, 0, 512) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_input_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_input_cons_buff_1 : memref<512xi8>, 0, 512) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_input_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%of_output_buff_0 : memref<512xi8>, 0, 512) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_output_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%of_output_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_output_buff_1 : memref<512xi8>, 0, 512) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_output_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      aie.end
