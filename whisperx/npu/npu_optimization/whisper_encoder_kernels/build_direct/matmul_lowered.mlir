module @matmul_npu_32x32 {
  aie.device(npu1) {
    ...
    %of_output_buff_0 = aie.buffer(%tile_0_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_output_buff_0"} : memref<1024xi8> 
    %of_output_buff_1 = aie.buffer(%tile_0_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "of_output_buff_1"} : memref<1024xi8> 
    ...
    %of_input_cons_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_input_cons_buff_0"} : memref<2048xi8> 
    %of_input_cons_buff_1 = aie.buffer(%tile_0_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_input_cons_buff_1"} : memref<2048xi8> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967294 step %c2 {
        ...
        func.call @matmul_int8_32x32_packed(%of_input_cons_buff_0, %of_output_buff_0) : (memref<2048xi8>, memref<1024xi8>) -> ()
        aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
        aie.use_lock(%of_output_cons_lock_0, Release, 1)
        aie.use_lock(%of_input_cons_cons_lock_0, AcquireGreaterEqual, 1)
        aie.use_lock(%of_output_prod_lock_0, AcquireGreaterEqual, 1)
        func.call @matmul_int8_32x32_packed(%of_input_cons_buff_1, %of_output_buff_1) : (memref<2048xi8>, memref<1024xi8>) -> ()
        aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
        aie.use_lock(%of_output_cons_lock_0, Release, 1)
      }
      aie.use_lock(%of_input_cons_cons_lock_0, AcquireGreaterEqual, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<2048xi8>, %arg1: memref<1024xi8>) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%of_input_cons_buff_0 : memref<2048xi8>, 0, 2048)
      aie.use_lock(%of_input_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_input_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_input_cons_buff_1 : memref<2048xi8>, 0, 2048)
      aie.use_lock(%of_input_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
