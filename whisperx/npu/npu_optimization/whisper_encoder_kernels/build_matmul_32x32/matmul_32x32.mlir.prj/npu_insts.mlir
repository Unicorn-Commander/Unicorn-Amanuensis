module @matmul_npu_32x32 {
  aie.device(npu1) {
    ...
    %of_output_buff_0 = aie.buffer(%tile_0_2) {address = 5120 : i32, sym_name = "of_output_buff_0"} : memref<1024xi8> 
    %of_output_buff_1 = aie.buffer(%tile_0_2) {address = 6144 : i32, sym_name = "of_output_buff_1"} : memref<1024xi8> 
    ...
    %of_input_cons_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "of_input_cons_buff_0"} : memref<2048xi8> 
    %of_input_cons_buff_1 = aie.buffer(%tile_0_2) {address = 3072 : i32, sym_name = "of_input_cons_buff_1"} : memref<2048xi8> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/ucadmin/UC-1/Unicorn-Amanuensis/whisperx/npu/npu_optimization/whisper_encoder_kernels/build_matmul_32x32/matmul_32x32.mlir.prj/main_core_0_2.elf", link_with = "matmul_32x32.o"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[512, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[256, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
