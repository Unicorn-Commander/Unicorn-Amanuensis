module @test_layernorm_512_nosqrt {
  aie.device(npu1) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @layernorm_512_nosqrt(%of_input_cons_buff_0, %of_output_buff_0) : (memref<1024xi8>, memref<1024xi8>) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
      aie.use_lock(%of_input_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_output_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @layernorm_512_nosqrt(%of_input_cons_buff_1, %of_output_buff_1) : (memref<1024xi8>, memref<1024xi8>) -> ()
      aie.use_lock(%of_input_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_output_cons_lock_0, Release, 1)
