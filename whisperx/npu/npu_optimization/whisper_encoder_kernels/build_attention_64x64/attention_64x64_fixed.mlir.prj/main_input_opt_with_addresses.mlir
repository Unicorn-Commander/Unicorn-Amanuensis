module @attention_npu_64x64 attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @of_QKV_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<12288 x i8>
  llvm.mlir.global external @of_QKV_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<12288 x i8>
  llvm.mlir.global external @of_out_buff_1() {addr_space = 0 : i32} : !llvm.array<4096 x i8>
  llvm.mlir.global external @of_out_buff_0() {addr_space = 0 : i32} : !llvm.array<4096 x i8>
  ...
  ^bb2:  // pred: ^bb1
    ...
    llvm.call @attention_64x64(%17, %16, %6) : (!llvm.ptr, !llvm.ptr, i32) -> ()
    ...
    llvm.call @attention_64x64(%19, %18, %6) : (!llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%8, %11) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%7, %11) : (i32, i32) -> ()
  ...
  ^bb3:  // pred: ^bb1
    ...
    llvm.call @attention_64x64(%22, %21, %6) : (!llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%8, %11) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%7, %11) : (i32, i32) -> ()
    llvm.return
  }
