    ...
    def _detect_npu(self):
        ...
        if os.path.exists('/dev/accel/accel0'):
            try:
                ...
                logger.info("✅ NPU Phoenix detected via direct device access")
        ...
        try:
            ...
            if result.returncode == 0 and 'NPU Phoenix' in result.stdout:
                ...
                logger.info("✅ NPU Phoenix detected via XRT tools")
            ...
            logger.warning("⚠️ XRT tools not found, but device access may still work")
        except Exception as e:
